        ...
        <div className="mx-4 my-5">
          ...
          <div className="flex flex-col mt-6">
            <div className="flex shadow rounded-search w-full mb-3">
              <input type="text" className="mx-5 my-4 w-full placeholder:text-search text-search" placeholder="Nama Lengkap" />
            </div>
            <div className="flex shadow rounded-search w-full mb-3">
              <input type="email" className="mx-5 my-4 w-full placeholder:text-search text-search" placeholder="Email" />
            </div>
            <div className="flex shadow rounded-search w-full mb-3">
              <input type="number" className="mx-5 my-4 w-full placeholder:text-search text-search" placeholder="Nomor Telepon" />
            </div>
            <div className="flex shadow rounded-search w-full mb-3">
              <input type="password" className="mx-5 my-4 w-full placeholder:text-search text-search" placeholder="Password" />
            </div>
          </div>
          <button className="flex justify-center items-center mt-6 bg-main rounded-search cursor-pointer w-full">
            <p className="text-white bold my-3">
                Sign Up
            </p>
          </button>
        </div>
